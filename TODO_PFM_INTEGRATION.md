# PFM Integration TODO List

## Phase 1: Core PFM Blueprint Creation
- [x] Create `blueprints/pfm.py` with basic structure
- [x] Add account linking and aggregation endpoints
- [x] Add budgeting and expense tracking endpoints
- [x] Add financial goal management endpoints
...
- [ ] Add investment tracking basics
